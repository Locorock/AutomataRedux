...
public class WorldData {
    ...
    public WorldData(int[] values) { //SOON GENETIC
        ...
        critterGeneticBounds.put ("BaseSpeed", new Double[]{shiftToRange (0.2, 0.5, 128, 256), shiftToRange (0.5, 1, 128, 256)});
        critterGeneticBounds.put ("WebbedFeet", new Double[]{shiftToRange (0, 1, 128, 256), shiftToRange (1, 1, 128, 256)});
        critterGeneticBounds.put ("Aggressivity", new Double[]{shiftToRange (0, 3, 0, 256), shiftToRange (3, 50, 16, 256)});
        ...
        critterParams.put ("mateCostHungerDenom", shiftToRange (2, 3, 128, 256));
        critterParams.put ("mateCostThirstDenom", shiftToRange (2, 3, 128, 256));
        critterParams.put ("mutationRate", shiftToRange (10000, 30000, 0, 256));
        critterParams.put ("stabilityThreshold", shiftToRange (100, 150, 128, 256)); //DA CALCOLARE CON UNA FUNZIONE
